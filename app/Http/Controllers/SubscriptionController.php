    ...
    public function subscription(Request $request)
    {
        ...
        //   ]);
          $customer=$stripe->customers->create([
            'name'=> 'Yasir_customer5',
            'email'=> 'yasir.arfat@gmail.com',
            'source'=> $stripetoken,
         ...
         echo $customer_id=$customer->id;
           $intent=$stripe->subscriptions->create([
            'customer' =>$customer_id, //YOU CAN use $customer_id here of newly created customer// if of customer created manually 'cus_N6vHru3GeVCyA4'
            'items' => [
