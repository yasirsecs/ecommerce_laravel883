            ...
            <div class="container mx-auto lg:px-10 " >
              ...
              <form action="{{route('subscription.subr')}}"  method="post" id="payment-form">
                ...
                <div class="mb-6">
                  ...
                  <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Write your address for delivery..."></textarea>
                </div>
                <div class="buy1 ">
                        ...
                        var displayError = document.getElementById('card-errors');
                         ...
                         form.addEventListener('submit', function(event) 
                         {
                             ...
                             stripe.createToken(cardElement).then(function(result)
                             {
                              ...
                              if(result.error)
                              {
                                //Inform customer that there is an error
