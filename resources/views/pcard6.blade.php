...
<div id="siteWrapper" class=" main-container container p-5 w-full">
    @include('layouts.mobile-navbar')
                <div class="  px-5 lg:px-0 flex flex-col lg:flex-row item-center justify-center" >
                    <div class="w-1/3 bg-red border">
                        <div class="item-images grid grid-rows-2 gap-1 w-full">
                          <div class="large-image-view w-full  border rounded-md ">
                            <a href="#">
                            <img class=" p-5 max-w-sm " src="{{asset('images/shoe2.png')}}" alt="product image">
                            </a>
                          </div>
                    ...
                    <div class="w-1/4   rounded-lg dark:bg-gray-800 dark:border-gray-700 border  ">
                      <div class="px-5 pb-5">
                        <a href="#">
                        ...
                        <div class="flex ">
                          ...
                          <div class="price"><span class="text-3xl font-bold text-gray-900 dark:text-white">$599</span></div>
